...
_See the [OpenAuth doc page](/pages/openauth) for details about how OpenAuth works and how to troubleshoot potential problems._
...
![Logging in to Odyssey using two-factor authentication.]({filename}/images/OpenAuth-verification-code.png)
...
An enhanced module system called Helmod is used on Odyssey to control the run-time environment for individual applications. To find out what modules are available you can either look at the [module list on the RC / Informatics portal](https://portal.rc.fas.harvard.edu/apps/modules), or use the `module avail` command. By itself, module avail will print out the entire list of packages. To find a specific tool, use the module spider command.
...
![Example of SLURM batch job submission and monitoring]({filename}/images/sbatch-example.png)
